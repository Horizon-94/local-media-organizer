...
# -*- coding: utf-8 -*-
"""
stop03_1_monitor_process_tree_db_safe_v5_20260709_124012.py
...
SCRIPT_VERSION = "v5_20260709_124012"
...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    ap.add_argument("--output-dir", type=str, help="Allowed output directory for SQLite/CSV/JSON.")
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if not args.output_dir:
        fail("BLOCKED_MISSING_OUTPUT_DIR", "provide --output-dir inside allowed output roots")
    monitor_pid(
        pid=int(args.pid),
