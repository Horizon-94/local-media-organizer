...
# -*- coding: utf-8 -*-
"""
stop03_1_monitor_process_tree_db_safe_v6_20260709_171800.py
...
SCRIPT_VERSION = "v6_20260709_171800"
...
EXPECTED_PYTHON = Path("/Users/yourname/Documents/AI-Local/envs/media-archive-v06-visual/bin/python").resolve()
DEFAULT_OUTPUT_DIR = TEST_OUTPUT_ROOT / "stop03-monitor-process-tree-db-safe-v6_20260709_171800"
...
def runtime_preflight() -> Dict[str, Any]:
    ...
    return {
        ...
        "expected_python_match": Path(sys.executable).resolve() == EXPECTED_PYTHON,
        "script_version": SCRIPT_VERSION,
        "expected_script_local": str(PROJECT_ROOT / "scripts/03_stop03_visual_analysis/stop03_1_monitor_process_tree_db_safe_v6_20260709_171800.py"),
