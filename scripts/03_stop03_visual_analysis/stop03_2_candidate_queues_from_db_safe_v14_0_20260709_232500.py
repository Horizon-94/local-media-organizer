...
# -*- coding: utf-8 -*-
"""
Stop03-2 Candidate Queues from DB - safe V14.0 DB-only timelapse + strict screen OCR + no screen Qwen + tail suppression + human composition preference.
...
# -----------------------------------------------------------------------------
SCRIPT_VERSION = "stop03_2_candidate_queues_from_db_safe_v14_0_20260709_232500"
POLICY_VERSION = "stop03_2_generic_high_value_rules_v10_v14_0_human_composition_no_screen_qwen_no_tail_20260709"
...
DEFAULT_OUT = TEST_OUTPUT_ROOT / "stop03-2-candidate-queues-db-safe-v14_0_20260709_230500"
...
TAIL_FRAME_SUPPRESS_RATIO = 0.03
TAIL_FRAME_SUPPRESS_MIN_MS = 3000
TAIL_FRAME_SUPPRESS_MAX_MS = 15000
    ...
    for r in rows:
        ...
        if r.get("manual_seed"):
            ...
            c.update({
                ...
                "video_frame_rank": "",
                "video_candidate_budget": "reason_based_segment_guard_v14_human_composition_no_screen_qwen_no_tail_not_fixed_target",
    ...
    for gid, group0 in sorted(video_groups.items()):
        ...
        if SCREEN_RECORDING_QWEN_DISABLED and screen_capture_group:
            video_reports.append({
                ...
                "video_candidate_budget": "screen_recording_qwenvl_disabled_ocr_only_v14",
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    try:
        ...
        summary = {
            ...
            "video_ocr_candidate_source_policy": "strict_screen_capture_video_only; still_image_ocr_disabled; normal_camera_video_ocr_disabled_by_default_in_v14",
            ...
            "settings": {
                ...
                "selection_mode": "generic_dynamic_reason_based_v14_0_human_composition_no_screen_qwen_no_tail_strict_screen_ocr_db_only_timelapse_no_default_cap",
