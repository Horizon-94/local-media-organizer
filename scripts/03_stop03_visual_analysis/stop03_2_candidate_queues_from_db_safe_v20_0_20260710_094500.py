...
SCRIPT_VERSION='stop03_2_candidate_queues_from_db_safe_v20_0_20260710_094500'
POLICY_VERSION='stop03_2_generic_high_value_rules_v20_content_aware_coverage_v14_supplement_20260710'
...
DEFAULT_OUT=TEST_OUTPUT_ROOT/'stop03-2-candidate-queues-db-safe-v20_0_20260710_094500_full'
...
def v20_coverage_dedup(chosen_rows, labels, min_gap_ms=18000, grid_threshold=9.0, label_sim_threshold=0.70):
...
def run(args):
    ...
    for sid,fs in by_video.items():
        ...
        if is_screen(path):
            ...
            for f in chosen:
                ...
                if overlap: stats['v20_v17_v14_overlap_count']+=1
            ...
            for vr in v14_high_by_source.get(sid,[]):
                ...
                if not f or is_black(f) or is_tail(f, sorted_frames):
                    stats['v20_v14_supplement_reject_bad_or_tail_count']+=1
                    continue
                if min_gap_ms(f, selected_video_frames) < int(args.v14_supplement_min_gap_ms):
                    stats['v20_v14_supplement_reject_near_coverage_count']+=1
                    continue
                ...
                selected_video_frames.append(f); selected_vus.add(vu); added+=1; stats['v20_v14_supplement_added_count']+=1
    ...
    stats['v20_final_video_dedup_drop_count'] = len(final_dropped_rows)
    stats['v20_final_video_dedup_before_count'] = q_before_final_dedup
    stats['v20_final_video_dedup_after_count'] = len(q)
