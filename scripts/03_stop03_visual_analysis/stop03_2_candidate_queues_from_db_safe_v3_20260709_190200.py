...
# -----------------------------------------------------------------------------
SCRIPT_VERSION = "stop03_2_candidate_queues_from_db_safe_v3_20260709_190200"
POLICY_VERSION = "stop03_2_candidate_queues_from_db_safe_v3_policy_20260709"
...
def runtime_preflight(con: sqlite3.Connection, db_path: Path, out_path: Path) -> Dict[str, Any]:
    ...
    return {
        ...
        "input_policy": "read_current_sqlite_tables_visual_units_derived_assets_source_assets_visual_labels_embeddings_manual_high_value_visual_seeds",
...
def load_units(con: sqlite3.Connection) -> List[Dict[str, Any]]:
    ...
    SELECT
      ...
      sa.source_file_id AS original_source_file_id
