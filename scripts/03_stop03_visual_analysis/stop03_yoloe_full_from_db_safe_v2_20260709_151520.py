...
# -*- coding: utf-8 -*-
"""
Stop03 YOLOE full from DB, local-only safe v2.
...
SCRIPT_VERSION = "stop03_yoloe_full_from_db_safe_v2_20260709_151520"
...
DEFAULT_OUT = Path("/Users/yourname/Documents/AI-Local/test-output/stop03-yoloe-full-db-safe-v2_20260709_151520")
...
def db_audit(db: Path, model: Path, mobileclip: Path, registry: Optional[Path]) -> Dict[str, Any]:
    ...
    schema_info = {t: table_info_map(con, t) for t in ["visual_units", "derived_assets", "visual_labels", "model_runs"]}
    sample = []
    try:
