...
# -*- coding: utf-8 -*-
"""
Stop03-2 Candidate Queues from DB - safe V9.0 DB-materialized timelapse convergence candidate.
...
# -----------------------------------------------------------------------------
SCRIPT_VERSION = "stop03_2_candidate_queues_from_db_safe_v9_0_20260709_203800"
POLICY_VERSION = "stop03_2_generic_high_value_rules_v5_v9_0_db_materialized_timelapse_20260709"
...
DEFAULT_OUT = TEST_OUTPUT_ROOT / "stop03-2-candidate-queues-db-safe-v9_0_20260709_203800"
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    p.add_argument("--step02-timelapse-manifest", type=Path, default=STEP02_IMAGE_VISUAL_UNIT_MANIFEST_DEFAULT, help="Frozen Step02 image visual unit manifest used only to materialize timelapse metadata into DB when missing.")
    p.add_argument("--refresh-step02-timelapse-db", action="store_true", help="Refresh DB table step02_image_timelapse_keyframes from the frozen Step02 manifest.")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    step02_timelapse_materialization = materialize_step02_timelapse_keyframes(
        con,
        assert_out_path(args.step02_timelapse_manifest) if False else Path(args.step02_timelapse_manifest).expanduser().resolve(strict=False),
        refresh=bool(args.refresh_step02_timelapse_db),
    )
    rows = load_units(con)
    ...
    try:
        ...
        summary = {
            ...
            "settings": {
                ...
                "selection_mode": "generic_dynamic_reason_based_v9_0_db_materialized_timelapse_no_default_cap",
