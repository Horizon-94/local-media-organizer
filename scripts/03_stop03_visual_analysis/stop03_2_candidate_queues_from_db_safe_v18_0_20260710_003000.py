...
SCRIPT_VERSION='stop03_2_candidate_queues_from_db_safe_v18_0_20260710_003000'
POLICY_VERSION='stop03_2_generic_high_value_rules_v18_v17_base_v14_supplement_db_only_20260710'
...
DEFAULT_OUT=TEST_OUTPUT_ROOT/'stop03-2-candidate-queues-db-safe-v18_0_20260710_003000_full'
    ...
    for sid,fs in by_video.items():
        ...
        if is_screen(path):
            ...
            for f in chosen:
                ...
                if overlap: stats['v18_v17_v14_overlap_count']+=1
            ...
            for vr in v14_high_by_source.get(sid,[]):
                ...
                if not f or is_black(f) or is_tail(f, sorted_frames):
                    stats['v18_v14_supplement_reject_bad_or_tail_count']+=1
                    continue
                if min_gap_ms(f, selected_video_frames) < int(args.v14_supplement_min_gap_ms):
                    stats['v18_v14_supplement_reject_near_coverage_count']+=1
                    continue
                ...
                selected_video_frames.append(f); selected_vus.add(vu); added+=1; stats['v18_v14_supplement_added_count']+=1
