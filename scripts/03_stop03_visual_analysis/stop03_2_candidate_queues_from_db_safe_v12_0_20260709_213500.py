...
# -*- coding: utf-8 -*-
"""
Stop03-2 Candidate Queues from DB - safe V12.0 DB-only timelapse + wider video time-coverage gate + video-only OCR candidate.
...
# -----------------------------------------------------------------------------
SCRIPT_VERSION = "stop03_2_candidate_queues_from_db_safe_v12_0_20260709_213500"
POLICY_VERSION = "stop03_2_generic_high_value_rules_v8_v12_0_video_12_5_15pct_image_ocr_off_20260709"
...
DEFAULT_OUT = TEST_OUTPUT_ROOT / "stop03-2-candidate-queues-db-safe-v12_0_20260709_213500"
...
def generic_video_group_guard(max_time_ms: int, frame_count: int) -> int:
    ...
    V12 opens the V11 video gate one more step. The goal is not a fixed quota,
    ...
    for r in rows:
        ...
        if r.get("manual_seed"):
            ...
            c.update({
                ...
                "video_frame_rank": "",
                "video_candidate_budget": "reason_based_segment_guard_v12_time_coverage_not_fixed_target",
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    try:
        ...
        summary = {
            ...
            "video_ocr_candidate_source_policy": "video_frame_only; still_image_ocr_disabled_by_default_in_v12",
            ...
            "settings": {
                ...
                "selection_mode": "generic_dynamic_reason_based_v12_0_wider_video_time_coverage_db_only_timelapse_image_ocr_off_no_default_cap",
