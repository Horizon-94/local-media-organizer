...
# -*- coding: utf-8 -*-
"""
Stop03-2 Candidate Queues from DB - safe V8.0 generic-rule freeze candidate.
...
# -----------------------------------------------------------------------------
SCRIPT_VERSION = "stop03_2_candidate_queues_from_db_safe_v8_0_20260709_201800"
POLICY_VERSION = "stop03_2_generic_high_value_rules_v4_v8_0_timelapse_min_rep_20260709"
...
DEFAULT_OUT = TEST_OUTPUT_ROOT / "stop03-2-candidate-queues-db-safe-v8_0_20260709_201800"
...
def load_units(con: sqlite3.Connection) -> List[Dict[str, Any]]:
    ...
    for r in rows:
        ...
        path_blob = " ".join(str(r.get(k) or "") for k in ["derived_type", "derived_path", "visual_file", "source_relative_path", "original_source_path_at_processing_time"]).lower()
        # Timelapse is a group-level visual object. It must not be filtered as an ordinary still image.
        if ("timelapse" in path_blob) or ("keyframe_pool" in path_blob and r["visual_unit_type"] != "video_frame"):
            r["source_group_kind"] = "timelapse"
            r["source_group_id"] = timelapse_group_key(r)
    ...
    try:
        ...
        summary = {
            ...
            "settings": {
                ...
                "selection_mode": "generic_dynamic_reason_based_v8_0_timelapse_min_rep_no_default_cap",
