...
SCRIPT_VERSION = "step01_source_scan_lineage_dedup_db_safe_v5_20260709_173800"
...
DEFAULT_OUT = TEST_OUTPUT_ROOT / "step01-source-scan-db-safe-v5_20260709_173800"
...
def runtime_preflight(source_roots: Optional[List[Path]] = None, db_path: Optional[Path] = None,
    ...
    assets = {
        ...
        "expected_python_launcher": asset_status(EXPECTED_PYTHON),
...
def main():
    ...
    preflight = runtime_preflight(source_roots=source_roots, db_path=db_path, out_path=base_out, scan_macos_tags=args.scan_macos_tags)
