...
SCRIPT_VERSION = "step02_2_image_preview_from_db_safe_v4_20260709_133015"
...
DEFAULT_OUT = Path("/Users/yourname/Documents/AI-Local/test-output") / "step02-2-image-preview-db-safe-v3_20260709_132210"
...
def audit_project_db_for_step02(db_path: Path) -> dict:
    db_path = db_path.expanduser().resolve()
    conn = sqlite3.connect(str(db_path))
    conn.row_factory = sqlite3.Row
    ensure_project_db_tables(conn)
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if args.db_audit_only:
        print(json.dumps(audit_project_db_for_step02(db_path), ensure_ascii=False, indent=2))
        return 0
